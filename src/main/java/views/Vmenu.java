...
public class Vmenu extends JFrame {
	...
	/**
	 * Crea y prepara la ventana del men� .
	 * 
	...
	/**
	 * Crea la secci�n para ver y seleccionar las carpetas y ficheros.
	 * 
	 * @param window Contenedor que contiene al resto de paneles.
	 * @throws IOException 
	 */
	...
	/**
	 * Crea la secci�n con los botones para seleccionar la opci�n a realizar. Si es
	 * usuario es un directivo tendr� una opci�n extra que es la de gestionar los
	 * usuarios.
	 * 
	 * @param window      Contenedor que contiene al resto de paneles.
